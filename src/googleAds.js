...
/**
 * Fetches enabled Performance Max text assets (headlines, long headlines & descriptions) with performance labels.
 * @param {object} config - Configuration object
 * @param {string} accessToken - Current OAuth2 access token
  ...
  try {
    ...
    return assets.map(item => {
      ...
      return {
        ...
        fieldType: aga.fieldType, // 'HEADLINE', 'LONG_HEADLINE', 'DESCRIPTION'
        performanceLabel: aga.performanceLabel || 'LEARNING',
